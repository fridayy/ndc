...
export class DependencyFileReader implements FileReader<Observable<Dependency>> {
    ...
    read(path: string): Observable<Dependency> {
        ...
        return Observable.fromPromise(promisifiedFileReader(path, 'UTF-8'))
            ...
            .flatMap(packageJson => Observable.of(packageJson.dependencies, packageJson.devDependencies))
            .flatMap(json => {
